...
export function Footer() {
  return (
    <footer className="bg-white text-steel-700">
      ...
      <div className="container-x pt-20 pb-14 grid gap-10 lg:grid-cols-12">
        ...
        <div className="lg:col-span-3">
          ...
          <h4 className="text-[11px] uppercase tracking-[0.25em] text-steel-500 mb-4 mt-8 font-bold">Follow</h4>
          <div className="flex items-center gap-2">
            {[
              ...
              <a
                ...
                aria-label={s.label}
                className="w-9 h-9 rounded-full border border-steel-300 text-steel-600 hover:border-rope-500 hover:text-rope-600 inline-flex items-center justify-center transition"
              >
